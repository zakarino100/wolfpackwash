export const pageContent = {
  about: {
    ...
    description:
      "Wolf Pack Wash is a locally owned exterior cleaning company serving the Triangle area. We handle house washing, window cleaning, gutter cleaning, concrete, decks, driveways, lighting installs, and recurring exterior care — with real communication, strong results, and no-hassle scheduling.",
  },
  services: {
    eyebrow: "Our Services",
    title: "Exterior cleaning services built to make your property look better fast.",
    description:
      "From house washing and window cleaning to concrete pressure washing and holiday lighting, Wolf Pack Wash handles every part of your home's exterior. Pick one service or bundle several — we make it easy to get everything done in one visit.",
  },
  residential: {
    eyebrow: "Residential Cleaning",
    title: "Professional exterior cleaning for homes across the Triangle.",
    description:
      "Whether it's pollen season buildup, dirty windows, stained driveways, or clogged gutters, Wolf Pack Wash delivers fast, thorough results for homeowners across Raleigh, Cary, Apex, Holly Springs, and the surrounding Triangle area.",
  },
  commercial: {
    eyebrow: "Commercial Cleaning",
    title: "Keep storefronts, sidewalks, and exterior surfaces looking sharp.",
    description:
      "First impressions matter. Wolf Pack Wash provides reliable commercial exterior cleaning for storefronts, parking areas, and building surfaces. We work around your schedule to keep things clean with minimal disruption to your business.",
  },
  contact: {
    eyebrow: "Contact",
    title: "Get your free quote and we'll follow up fast.",
    description:
      "Fill out the form and we'll reach out the same day with pricing and scheduling options. No waiting around, no confusing callbacks — just a straightforward quote and a date on the calendar.",
  },
  gallery: {
    eyebrow: "Our Work",
    title: "Real results on real properties across the Triangle.",
    description:
      "Every job we do is a before-and-after worth showing. Browse our gallery of house washes, window cleans, concrete and driveway work, and lighting installs — and see what a difference the right team makes.",
  },
  reviews: {
    eyebrow: "Reviews",
    title: "Hear it from the homeowners we've already helped.",
    description:
      "Wolf Pack Wash has built a strong reputation across the Triangle for fast response, reliable results, and honest communication. Read what our customers have to say, and see why they keep coming back.",
  },
  softWashing: {
  ...
  blog: {
    ...
    description:
      "Practical advice on house washing, window cleaning, gutter maintenance, pressure washing, and exterior lighting from the Wolf Pack Wash team. Real guidance for Triangle homeowners who want to keep their property in great shape.",
  },
} as const;
