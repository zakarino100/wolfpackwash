...
export function PageBuilder({ eyebrow, title, description, sourcePage, bullets = [] }: PageBuilderProps) {
  return (
    <>
      ...
      <section className="bg-neutral-950 py-16 text-white sm:py-20">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
          <Reveal>
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-amber-300">What this page should do</p>
