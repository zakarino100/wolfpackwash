  ...
  return (
    <section className="bg-[#07111b] py-20 text-white sm:py-28">
      <div className="mx-auto max-w-4xl px-4 text-left sm:px-6 lg:px-8">
        ...
        {image ? (
          <div className="mt-10 overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] shadow-[0_24px_70px_rgba(0,0,0,0.18)]">
            <img src={image} alt={title} className="h-[260px] w-full object-cover sm:h-[340px]" />
          </div>
        ) : null}
      </div>
    </section>
