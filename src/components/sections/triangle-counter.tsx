  ...
  return (
    <section className="bg-[#080808] py-16 text-white sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal className="rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top,rgba(200,25,32,0.10),transparent_45%),rgba(255,255,255,0.03)] p-6 sm:p-8 lg:p-10">
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            ...
            <div className="rounded-[2rem] border border-[#C81920]/20 bg-black/40 p-6 text-center shadow-[0_0_60px_rgba(200,25,32,0.10)] sm:p-8">
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-white/50">Homes cleaned</p>
              <div className="mt-4 text-5xl font-semibold text-[#C81920] sm:text-7xl">
